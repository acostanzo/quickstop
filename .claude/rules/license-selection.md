...
Shipped quickstop marketplace plugins use MIT. The `plugin.json` for claudit carries `"license": "MIT"`. Smith-scaffolded plugins under `plugins/` follow the same convention when the user confirms MIT.
