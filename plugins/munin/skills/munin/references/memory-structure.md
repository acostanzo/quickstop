...
Reference for the recall agent. Documents the memory repo layout and search strategies.
...
memory-repo/
  ...
  inbox/                 # Raw session transcripts (Bifrost captures these)
    processed/           # Transcripts after Heimdall consolidation
```
